    ...
    public void InventoryOrToolbeltSizeChanged() {
        for (int i = 0; i < ItemButtons.Length; i++) {
            ...
            if (i < PlayerToolbeltController.LocalInstance.ToolbeltSizes[2]) {
                if (i < PlayerToolbeltController.LocalInstance.CurrentToolbeltSize) {
        ...
        _toolbeltRarityIcon.sprite = Array.IndexOf(PlayerToolbeltController.LocalInstance.ToolbeltSizes, PlayerToolbeltController.LocalInstance.CurrentToolbeltSize) switch {
            0 => _rarityIconSprites[0],
            1 => _rarityIconSprites[1],
            _ => _rarityIconSprites[2],
        };
