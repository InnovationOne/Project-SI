...
/// <summary>
/// Tree stump resource node logic.
/// </summary>
public class TreeStumpResourceNode : ResourceNodeBase {
    [SerializeField] ItemSpawnManager.SpreadType _spreadType;

    public override bool CanHitResourceNodeType(HashSet<ResourceNodeType> canBeHit) => canBeHit.Contains(ResourceNodeType.TreeStump);
