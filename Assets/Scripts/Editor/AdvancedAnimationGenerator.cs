...
/// </summary>
public class AdvancedAnimationGenerator : EditorWindow {
    [Header("Mode")]
    ...
    [MenuItem("Tools/Advanced Animation Generator (Texture2D)")]
    public static void ShowWindow() {
        GetWindow<AdvancedAnimationGenerator>("Texture2D Animation Generator");
    }
